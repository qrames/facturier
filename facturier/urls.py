...
from main_app.ajax_views import QuotationFieldEditView, QuotationLineFieldEditView, QuotationLineCreateView
...
urlpatterns = [
    ...
    url(r'^quotation-line/add/(?P<id>[\d]+)/(?P<field_name>[-\w]+)$', QuotationLineCreateView.as_view() , name="create-field-line-quotation"),

    url(r'^quotation-line/(?P<id>[\d]+)/(?P<field_name>[-\w]+)$', QuotationLineFieldEditView.as_view() , name="edit-field-line-quotation"),

    url(r'^quotation/(?P<pk>[\d]+)/(?P<field_name>[-\w]+)$', QuotationFieldEditView.as_view() , name="edit-field-quotation"),
